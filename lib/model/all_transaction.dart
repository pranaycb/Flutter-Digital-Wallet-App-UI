class AllTransaction {
  ...
  final tranAmount;
  final tranStatus;
  AllTransaction(this.svgSrc, this.tranType, this.tranDate, this.tranAmount,
      this.tranStatus);
}

List<AllTransaction> transaction = getTransaction.map(
      (item) => AllTransaction(item['svgSrc'], item['tranType'],
